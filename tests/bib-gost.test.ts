...
const tests: { input: BibItem; expected: string }[] = [
	{
		...
		expected: 'Самарский, А. А. Теория разностных схем [Текст] : учеб. пособие / А. А. Самарский. – М. : Наука, 1977. – 656 с.'
	},
	{
		input: {
		...
		expected: 'Тихонов, А. Н. Уравнения математической физики [Текст] : учеб. пособие / А. Н. Тихонов, А. А. Самарский. – М. : Наука, 1972. – 736 с.'
	},
	{
		input: {
		...
		expected: 'Ильясова, Н. Ю. Информационные технологии анализа изображений в задачах медицинской диагностики [Текст] / Н. Ю. Ильясова, А. В. Куприянов, А. Г. Храмов. – М. : Радио и связь, 2012. – 424 с.'
	},
	{
		input: {
			citationKey: 'volkov',
		...
		expected: 'Методы компьютерной оптики [Текст] : учеб. для вузов / А. В. Волков [и др.] ; под ред. В. А. Сойфера. – 2-е изд., испр. – М. : Физматлит, 2003. – 688 с.'
	},
	{
		input: {
			citationKey: 'fursov',
		...
		expected: 'Фурсов, В. А. Построение КИХ-фильтров в заданном параметрическом классе частотных характеристик [Текст] / В. А. Фурсов // Компьютерная оптика. – 2016. – Т. 40, № 6. – С. 878-886.'
	},
	{
		input: {
		...
		expected: 'Петергоф [Электронный ресурс] // Википедия: свободная энцикл. – Электрон. дан. – [Б. м.], 2012. – URL: http://ru.wikipedia.org/wiki/Петродворец (дата обращения: 08.11.2012).'
	}
];
