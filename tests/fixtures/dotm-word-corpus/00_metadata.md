...
topic: 'Сравнение геометрии стилей DOTM'
supervisorName: 'Петров Петр Петрович'
supervisorTitle: 'кандидат технических наук, доцент кафедры технической кибернетики'
city: 'Самара'
year: 2026
bibliography: 'tests/fixtures/dotm-word-corpus/references.bib'
---
