...
| Качество BibTeX                                                        | Partially implemented | DOI shape, future `urldate`, English `langid`, book page ranges and working-paper-as-article warnings; достоверность полей не проверяется |
