...
рассматриваются отдельно. Статус `accepted` подтверждает техническую Word-приёмку, но пока не гарантирует
полное соответствие СТО или отсутствие незаполненных счётчиков реферата.

[Задачи устранения пробелов](docs/audits/2026-09-22-sto-coverage/backlog.md) заведены на [доске задач](kanban/tasks) в репозитории. Критические задачи включают проверку прямого форматирования, сохранность кода,
ошибки формул, статистику реферата и эталонную проверку Word. Требования к присутствующим конструкциям
