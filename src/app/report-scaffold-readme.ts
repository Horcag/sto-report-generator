...
Перед командами выполните редакторский проход по связному русскому тексту исходных Markdown-файлов. Если текст пишет
или редактирует агент, он должен применить навык humanizer-ru из .agents/skills/humanizer-ru/SKILL.md в корне
STO Report Generator. Уберите явные артефакты копирования и неуместные шаблонные фразы, сохраняя научные термины,
факты, ссылки и формулы. Если вы пишете без агента, проверьте текст вручную по docs/report-authoring.md в корне
генератора. Сам генератор текст не переписывает и не проверяет факт выполнения этого шага.
