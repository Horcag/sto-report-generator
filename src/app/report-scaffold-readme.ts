...
Перед командами перечитайте связный русский текст исходных Markdown-файлов: уберите явные артефакты копирования и
неуместные шаблонные фразы, сохраняя научные термины, факты, ссылки и формулы. При наличии навыка humanizer-ru и запросе
на редактуру можно использовать его для этой проверки. Сам генератор текст не переписывает и от навыка не зависит.
